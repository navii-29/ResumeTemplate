  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a Mumbai based <strong className="text-stone-100">Python Developer and Data Scientist</strong>, recently worked
        at <strong className="text-stone-100">Cogoport as Automation Developer</strong> build Workflow for freights booking till freights delivery across International Markets.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
...
export const portfolioItems: PortfolioItem[] = [
  {
    title: 'Web Digest AI',
    description: 'An LLM-powered web application that generates concise digest-style summaries of websites \
Users can register, submit a webpage URL, and receive an AI-generated summary of the page content.',
  ...
  {
    title: 'Mail Shiled',
    description: 'MailShield is an end-to-end machine learning web application designed to \
  ...
  },
  {
    ...
    description: 'This project implements a Next Word Prediction system using a Long Short-Term Memory (LSTM) neural network.\
Given an incomplete sentence, the model predicts the most likely next word based on learned language patterns.' ,
  ...
  },
  {
    ...
    description: 'An interactive Tableau dashboard analyzing Netflix’s global content trends using a dataset of 6K+ titles.This project explores Netflix’s catalog to uncover insights \
  ...
  },
  {
    ...
    description: 'A production-style RESTful API for image classification built using Flask, InceptionV3, MongoDB, and Docker.\
This project focuses on understanding the complete backend + ML deployment workflow — from authentication and token control to\
 model inference and containerized deployment.',
  ...
  },
  {
    ...
    description: 'This project demonstrates Multiple Linear Regression using the California Housing dataset from Scikit-Learn. It includes data loading, \
  ...
  },
  {
    ...
    description: 'This project focuses on predicting the selling price of used cars using the CarDekho dataset.A Random Forest Regressor is trained after proper data cleaning, preprocessing, and feature engineering.\
  ...
  {
    title: 'Plagiarism',
    description: 'A production-style REST API that detects text similarity using  NLP similarity scoring  \
  ...
  },
  {
    ...
    description: 'Streamlit web application for predicting customer churn probability using a trained TensorFlow ANN model.\
  ...
  },
  {
    ...
    description: 'A web application that predicts the sentiment of movie reviews using a deep learning model built with TensorFlow/Keras and deployed with Streamlit.\
  ...
  },
  {
    ...
    description: 'A secure RESTful banking API built with Flask, Flask-RESTful, and MongoDB. Supports user registration, account management, transfers, loans, \
...
export const education: TimelineItem[] = [
  {
    ...
    title: 'High School',
    content: <p>Completed my High School with major in Mathematics and Computer Science , there I learnt very profound things that is and will help in life , like interactions , punctuality , honesty , being respectful to others.</p>,
  },
  {
    ...
    content: <p>Completed my graduation as an ENTC engineer with a Minor in Data Science,where I learnt about Communications Technologies,Control Systems,Coding with Python.</p>,
  },
];
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
      • Built automated workflows to streamline freight booking processes, along with their whole journey from source to destination location and standardize business tasks.
      • Wrote Techinial Documentation on how to build Automated Workflows as task given so that upcoming developer can refer that while building workflows. 
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
      • Completed customer churn analysis for a utility client (Power Co.) using Python (Pandas, NumPy) and visual analytics.
      • Engineered and tuned a random forest model achieving 80% recall for churn prediction; delivered concise executive insights.
      </p>
    ),
  },
];
...
export const socialLinks: Social[] = [
  ...
  {label: 'Instagram', Icon: InstagramIcon, href: 'https://www.instagram.com/shudanshu_rajput_16?igsh=MXc0NGVhMGJwZmRhcw=='},
